...
const ESTADO_BADGE = {
  disponible: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300',
  ocupado: 'bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-300',
};
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 dark:bg-slate-800">
          ...
          {cargando ? (
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">No hay repartidores registrados.</p>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
                <thead>
                ...
                <tbody>
                  {repartidores.map((r) => {
                    ...
                    return (
                      <tr key={r.ci_repartidor} className="border-b border-slate-100 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800">
                        ...
                        <td className="py-2 pr-4">
                          <span
                            className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${
                              ESTADO_BADGE[estadoLower] || 'bg-slate-100 text-slate-600 dark:bg-slate-700 dark:text-slate-300'
                            }`}
                          >
                            {r.estado_disponible}
                          </span>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-lg p-6 dark:bg-slate-800">
            ...
            <form onSubmit={handleEditar} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1 dark:text-slate-200">Estado</label>
                <select
      ...
      {repartidorAEliminar && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-lg p-6 dark:bg-slate-800 w-full max-w-sm">
            ...
            <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Eliminar repartidor</h4>
