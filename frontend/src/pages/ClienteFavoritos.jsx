              ...
              {favoritos.map((p) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <p className="font-medium text-slate-800 dark:text-slate-100">{p.nombre_producto}</p>
                    ...
                    <div className="mt-auto flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 text-slate-400 dark:text-slate-500 hover:text-red-600 disabled:opacity-50 transition"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
